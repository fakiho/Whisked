...
struct WhiskedCategoryListView: View {
...
#Preview("Success State") {
    ...
    WhiskedCategoryListView(
        coordinator: WhiskedMainCoordinator(),
        viewModel: CategoryListViewModel(networkService: MockNetworkService.success(), category: .dessert)
    )
}

#Preview("Loading State") {
    @Previewable @Namespace var heroNamespace
    let viewModel = CategoryListViewModel(networkService: MockNetworkService.success(), category: .dessert)
    WhiskedCategoryListView(
        coordinator: WhiskedMainCoordinator(),
        viewModel: viewModel
    )
...
#Preview("Error State") {
    ...
    WhiskedCategoryListView(
        coordinator: WhiskedMainCoordinator(),
        viewModel: CategoryListViewModel(networkService: MockNetworkService.networkError(), category: .dessert)
    )
}
